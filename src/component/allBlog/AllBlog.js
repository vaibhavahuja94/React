    ...
    render() {
        ...
        return (
                ...
                <div className="panel panel-primary">
                    ...
                    <div className="panel-footer">
                        <h3>
                            ...
                            &nbsp;<span className="glyphicon glyphicon-thumbs-up" onClick={()=>this.likeBlog(value.id)}></span></span>):
                            (
                            <span>{blogStatus.filter(values=>(values.blog_id===value.id)&&(values.status==="like")).length}
                            &nbsp;<span className="glyphicon glyphicon-thumbs-up text-primary" onClick={()=>this.likeBlog(value.id)}></span>
                            </span>
                            )}
                            <span id="distance">
                            {(blogStatus===undefined)?
                            (<span>0 <span className="glyphicon glyphicon-thumbs-down" onClick={()=>this.disLikeBlog(value.id)}></span></span>):
            ...
            <Modal isOpen={this.state.showModal} style={customStyles}>
                    ...
                    <img src={this.state.img} alt="profile" className="img-responsive" width="250" height="300"/>
                    </div>
